...
first_file = Button(root, text="Select file", highlightbackground=color, width=70,
                    command=lambda: open_file())
first_file.place(x=0, y=30)

count_txt = Button(root, text="Count Words", highlightbackground=color,  width=70,
                   command=lambda: count(root.filename))
count_txt.place(x=0, y=60)

clear_txt = Button(root, text="Clear", highlightbackground=color,  width=70,
